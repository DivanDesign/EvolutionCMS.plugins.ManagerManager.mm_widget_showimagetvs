 ...
 * @param [thumbnailerUrl=''] {string} — Если у вас установлен PHPThumb, вы можете указать url, где он находится, адрес превью будет обращён к нему с передачей url исходной картинки, ширины и высоты.
...
$.fn.mm_widget_showimagetvs = function(params){
	...
	return (
		$(this)
			...
			.on(
				'change.mm_widget_showimagetvs load.mm_widget_showimagetvs',
				function(){
					var
						$this = $(this),
						//Get the new URL
